 ...
 * @author Waed
 */
public class StationOne extends javax.swing.JFrame {

    static WeatherStations stationOne = new WeatherStations("W001","52.95820042037341","-1.1540011360966105");
    ...
    /**
     * Creates new form StationOne
     */
    public StationOne() throws InterruptedException {
        initComponents();
        
        jLabelStationId.setText(stationOne.getId());
        latitudeField.setText(stationOne.getLatitude());
        longitudeField.setText(stationOne.getLongitude());
         ...
         Thread t1 = new Thread(){
            public void run(){
              ...
              while (true) {
                    ...
                    tempertureField.setText(stationOne.getTemperture() + "ºC");
                    humidityField.setText(stationOne.getHumidity() + "%");
                    pressureField.setText(stationOne.getPressure() + "kPa");
                    windDirectionField.setText(stationOne.getWindDirection() + " degrees");
                    cloudHeightField.setText(stationOne.getCloudHeight() + " m");
                    windSpeedField.setText(stationOne.getWindSpeed() + " mph");
                    precipitationField.setText(stationOne.getPrecipition() + " inches");
                    rainfallField.setText(stationOne.getRainfall() + " mm");
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Weather Station");
    ...
    public static void main(String args[]) throws IOException, InterruptedException{
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StationOne.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new StationOne().setVisible(true);
                } catch (InterruptedException ex) {
                    Logger.getLogger(StationOne.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
        
        socketOne = new Socket(SERVER_IP,SERVER_PORT);
        
        setSocket(socketOne);

        ServerConnection serverConn = new ServerConnection(socketOne);
        
        ServerConnection.setCurrentStaion(stationOne);
        
        //Goes out to the server
        PrintWriter out = new PrintWriter(socketOne.getOutputStream(),true);
        
        new Thread(serverConn).start();
         
        //The connection is started by sending the weather station details
        out.println(stationOne.getWeatherStationDetails());
        
        System.out.println("This station details: " + stationOne.getWeatherStationDetails());
        
    }
    
    public static void setSocket(Socket _currentSocket) {
        socketOne = _currentSocket;
    }
