 ...
 * @author Waed
 */
public class UserClientTwo extends javax.swing.JFrame {

    private static final String SERVER_IP = "127.0.0.1";
    private static final int SERVER_PORT = 9090;
    private static final String clientId = "U002";
    ...
    /**
     * Creates new form UserClientTwo
     */
    public UserClientTwo() throws InterruptedException, IOException{
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel11.setText("User Client: U002");
    ...
    public static void main(String args[]) throws IOException,  InterruptedException{
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserClientTwo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new UserClientTwo().setVisible(true);
                } catch (InterruptedException ex) {
                    ex.getMessage();
